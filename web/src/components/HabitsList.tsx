      ...
      {habitsInfo?.possibleHabits.map(habit => {
        return (
          <div className='flex items-center justify-between'>
            ...
            <span className='font-semibold text-xl text-white leading-tight  group-data-[state=checked]:line-through  group-data-[state=checked]:text-zinc-400 flex'>
              {habit.title} 
            </span>
            </Checkbox.Root>
            ...
            <div>
              ...
              >
                <Trash size={20} className='text-white mr-2'/>
              </button>
              <button
                className='cursor-pointer'
              >
